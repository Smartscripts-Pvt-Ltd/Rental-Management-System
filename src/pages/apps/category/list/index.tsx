...
// ** Actions Imports
import { fetchDataCategory, deleteCategory, editCategory, updateCategory } from 'src/store/apps/category'
...
import { CategoryType, UsersType } from 'src/types/apps/userTypes'
import { CardStatsHorizontalProps } from 'src/@core/components/card-statistics/types'

// ** Custom Table Components Imports
import TableHeader from 'src/views/apps/user/list/TableHeaderCategory'
